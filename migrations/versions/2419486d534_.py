...
Revision ID: 2419486d534
Revises: None
Create Date: 2015-05-04 12:28:35.851634

"""

# revision identifiers, used by Alembic.
revision = '2419486d534'
down_revision = None
...
def upgrade():
    ...
    sa.Column('broken', postgresql.ARRAY(sa.Integer()), nullable=True),
    sa.Column('ammo_max', sa.Integer(), nullable=True),
    sa.Column('fuel_max', sa.Integer(), nullable=True),
    sa.Column('ammo_use_base', sa.Integer(), nullable=True),
    sa.Column('fuel_use_base', sa.Integer(), nullable=True),
    ...
    sa.Column('modern_use', postgresql.ARRAY(sa.Integer()), nullable=True),
    ...
    sa.Column('level', sa.Integer(), nullable=True),
    sa.Column('repair_base', postgresql.ARRAY(sa.Integer()), nullable=True),
