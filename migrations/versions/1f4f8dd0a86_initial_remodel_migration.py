...
def upgrade():
    ...
    op.create_table('furniture',
                    ...
                    sa.Column('sale_flag', sa.Boolean(), nullable=True),
    ...
    op.create_table('stats',
                    ...
                    sa.Column('dive_bomber', sa.Integer(), nullable=True),
    ...
    op.create_table('admiral',
                    ...
                    sa.Column('max_kanmusu', sa.Integer(), nullable=True),
                    sa.Column('max_equipment', sa.Integer(), nullable=True),
    ...
    op.create_table('quest',
                    ...
                    sa.Column('bonus_flag', sa.Integer(), nullable=True),
                    sa.Column('invalid_flag', sa.Integer(), nullable=True),
                    sa.Column('code', sa.String(length=3), nullable=True),
                    sa.Column('resources_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['resources_id'], ['resources.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('remodel',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('level', sa.Integer(), nullable=True),
                    sa.Column('remodel_api_id', sa.Integer(), nullable=True),
                    sa.Column('id_resources', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['id_resources'], ['resources.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('admiral_equipment',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('level', sa.Integer(), nullable=True),
    ...
    op.create_table('admiral_furniture',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('active', sa.Boolean(), nullable=True),
                    sa.Column('admiral_id', sa.Integer(), nullable=True),
    ...
    op.create_table('admiral_usables',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('quantity', sa.Integer(), nullable=True),
                    sa.Column('admiral_id', sa.Integer(), nullable=True),
                    sa.Column('usable_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['admiral_id'], ['admiral.id'], ),
                    sa.ForeignKeyConstraint(['usable_id'], ['usable.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('quest_requirement',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('quest_id', sa.Integer(), nullable=True),
                    sa.Column('required_quest_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['quest_id'], ['quest.id'], ),
                    sa.ForeignKeyConstraint(['required_quest_id'], ['quest.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('ship',
                    ...
                    sa.Column('kai', sa.Boolean(), nullable=True),
                    sa.Column('getmsg', sa.Text(), nullable=True),
                    ...
                    sa.Column('max_stats_id', sa.Integer(), nullable=True),
                    ...
                    sa.ForeignKeyConstraint(['remodel_id'], ['remodel.id'], ),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('kanmusu',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('fleet_position', sa.Integer(), nullable=True),
                    sa.Column('number', sa.Integer(), nullable=False),
                    sa.Column('level', sa.Integer(), nullable=True),
                    sa.Column('experience', sa.Integer(), nullable=True),
                    sa.Column('current_hp', sa.Integer(), nullable=True),
                    sa.Column('current_fuel', sa.Integer(), nullable=True),
                    sa.Column('current_ammo', sa.Integer(), nullable=True),
    ...
    op.create_table('quest_bonus',
                    ...
                    sa.Column('ship_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['item_id'], ['equipment.id'], ),
                    sa.ForeignKeyConstraint(['quest_id'], ['quest.id'], ),
                    sa.ForeignKeyConstraint(['ship_id'], ['ship.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('dock',
                    ...
                    sa.Column('admiral_id', sa.Integer(), nullable=True),
                    sa.Column('kanmusu_id', sa.Integer(), nullable=True),
                    sa.Column('resources_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['admiral_id'], ['admiral.id'], ),
    ...
    op.create_table('kanmusu_equipment',
                    sa.Column('id', sa.Integer(), nullable=False),
